import { Box, Button, Grid, HStack, Image, VStack, Text, Badge } from "@chakra-ui/react";
...
export default function ProfileCard ({user}) {
    ...
    return (
        <Box cursor={'pointer'} w={'100%'} onClick={() => navigate('/public/' + user.nickname)}>
            ...
            <>
                <Image 
                    ...
                    objectFit={'cover'}
                    src={user.avatar_url} />
                <VStack alignItems={'flex-start'} spacing={2} w={'100%'} pt={2}>
                    <HStack w={'100%'}>
                ...
                <HStack h={'38px'} w={'100%'}>
                    <Button bgColor={'#202020'} color={'white'} w={'100%'} letterSpacing={'-1px'} fontSize={'14px'}>
